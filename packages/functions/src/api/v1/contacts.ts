...
import { ContactPersistence } from "../../lib/persistence/contact";
import type { ContactType, NewContactType } from "@charityops/types";
import { V1ApiBase } from "./base";
import type { APIGatewayProxyEventV2 } from "aws-lambda";

const contactPersistence = new ContactPersistence(Resource.ContactTable.name);

const api = new V1ApiBase<NewContactType, ContactType>(contactPersistence);
