...
import { InteractionPersistence } from "../../lib/persistence/interaction";
import type { InteractionType, NewInteractionType } from "@charityops/types";
import { V1ApiBase } from "./base";
import type { APIGatewayProxyEventV2 } from "aws-lambda";

const persistence = new InteractionPersistence(Resource.InteractionTable.name);

const api = new V1ApiBase<NewInteractionType, InteractionType>(persistence);
